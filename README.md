...
Last changes:
- 10-jan-2018: Disabled ArduinoOTA which makes it more stable and faster web response.
- 04-jan-2018: Web interface layout update, TFT layout update.
- 03-jan-2018: Changed the TFT Lib to TFT_ST7735-1.0p1, 4-button analog control, open AP mode.
